...
public class homePageController extends org.comicMovies.app.controller.BasedController {
    ...
    private ObservableList<Movies> loadMovies(String with_keywords) {
        String url = "https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=true&language=en-US&page=1&sort_by=popularity.desc&with_keywords=" + with_keywords;
